...
dishka-fastmcp follows semantic versioning. Security fixes target the latest
released minor.
...
[private vulnerability reporting](https://github.com/bagowix/dishka-fastmcp/security/advisories/new),
